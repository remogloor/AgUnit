...
namespace DummyTests.Silverlight4.NUnit
{
    ...
    public class Silverlight4RuntimeVersionTests
    {
        ...
        public void DeploymentRuntimeVersionIsCorrect()
        {
            ...
            Assert.IsTrue(runtimeVersion.StartsWith("5."), string.Format("Runtime version was {0}, expected 4.*", runtimeVersion));
        }
        ...
        public void SystemAssemblyVersionIsCorrect()
        {
            ...
            Assert.IsTrue(systemAssembly.Contains("5.0.5.0"), string.Format("System assembly version was {0}, expected 2.0.5.0", systemAssembly));
        }
    }
}